...
(1,'2019-01-01',NULL,NULL,NULL,'KATHIMERINH'),
...
(NULL,'Sports','Athlitika lol',NULL),
(NULL,'Politics','All things politics',NULL),
(NULL,'Esoteriki Politiki','All things politics',2),
(NULL,'Economics','All about the new CEID building budget',NULL);

INSERT INTO Article VALUES
('path1','Title1','Summary1',NULL,NULL,null,'aristeid@ceid.upatras.gr',15,NULL,NULL,'CEID Times',1,NULL),
('path2','Title2','Summary2',NULL,NULL,null,'christides@ceid.upatras.gr',24,NULL,NULL,'KATHIMERINH',1,NULL),
('path3','Title3','Summary3',NULL,NULL,null,'nikolosd@ceid.upatras.gr',24,NULL,NULL,'TO BHMA',1,Null);
